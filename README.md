...
- **Undo / Reset**: 실수해도 되돌리기 가능 (체크포인트 상태도 정확히 복원)
...
- **열쇠-자물쇠**: 금색 열쇠 블록(1x1)을 자물쇠 셀로 이동해야 출구 활성화. 미배치 시 출구 화살표가 흐리게 표시.
- **체크포인트**: 별 마커 셀을 고양이가 경유(pass-through 포함)해야 탈출 가능. 도달 시 금색 전환 + 펄스 링 애니메이션.
